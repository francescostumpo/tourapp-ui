...
const routes: Routes = [
  ...
  {
    path: 'tourApp/homepage',
    component: HomepageComponent,
    canActivate: [AuthGuardService],
    data: {expectedRoles: ['amministratore', 'operatore_biglietteria', 'operatore_biglietteria_comunale']}
  },
  // tslint:disable-next-line:max-line-length
  {
    path: 'tourApp/anagrafica',
    component: AnagraficaComponent,
    canActivate: [AuthGuardService],
    data: {expectedRoles: ['amministratore']}
  },
  {
    path: 'tourApp/anagrafica/siti',
    component: SitoComponent,
    canActivate: [AuthGuardService],
    data: {expectedRoles: ['amministratore']}
  },
  // tslint:disable-next-line:max-line-length
  {
    path: 'tourApp/anagrafica/tipologiaTickets',
    component: TicketTipologyComponent,
    canActivate: [AuthGuardService],
    data: {expectedRoles: ['amministratore']}
  },
  {
    path: 'tourApp/anagrafica/tourOperators',
    component: TourOperatorComponent,
    canActivate: [AuthGuardService],
    data: {expectedRoles: ['amministratore']}
  },
  {
    path: 'tourApp/ticketing',
    component: TicketingComponent,
    canActivate: [AuthGuardService],
    data: {expectedRoles: ['amministratore', 'operatore_biglietteria', 'operatore_biglietteria_comunale']}
  },
  {
    path: 'tourApp/ticketing/ticketStandard',
    component: TicketStandardComponent,
    canActivate: [AuthGuardService],
    data: {expectedRoles: ['amministratore', 'operatore_biglietteria', 'operatore_biglietteria_comunale']}
  },
  {
    path: 'tourApp/ticketing/ticketVirtual',
    component: TicketVirtualComponent,
    canActivate: [AuthGuardService],
    data: {expectedRoles: ['amministratore', 'operatore_biglietteria', 'operatore_biglietteria_comunale']}
  },
  // tslint:disable-next-line:max-line-length
  {
    path: 'tourApp/ticketing/verifyTicketStandard',
    component: TicketStandardValidateComponent,
    canActivate: [AuthGuardService],
    data: {expectedRoles: ['amministratore', 'operatore_biglietteria', 'operatore_biglietteria_comunale']}
  },
  // tslint:disable-next-line:max-line-length
  {
    path: 'tourApp/ticketing/verifyTicketVirtual',
    component: TicketVirtualValidateComponent,
    canActivate: [AuthGuardService],
    data: {expectedRoles: ['amministratore', 'operatore_biglietteria', 'operatore_biglietteria_comunale']}
  },
  {
    path: 'tourApp/booking',
    component: BookingComponent,
    canActivate: [AuthGuardService],
    data: {expectedRoles: ['amministratore']}
  },
  {
    path: 'tourApp/reporting',
    component: ReportingComponent,
    canActivate: [AuthGuardService],
    data: {expectedRoles: ['amministratore', 'operatore_comunale']}
  },
